...
document.PinLuo_Blocklist.action=url;
document.PinLuo_Blocklist.submit();
}
//-->
</script>
</head>
<body class="mainbg">
	<div id="mainhearder"><span>您的位置：企业网站管理系统 >> 网站碎片管理</span></div>
	
	<div id="hearder" class="hearder1"><span>网站碎片列表</span></div>
	
   <form action="PinLuo_Blocklist.asp" method="post" name="PinLuo_Blocklist" id="PinLuo_Blocklist">
   ...
   <tr>
	<td class="tableleft">
		...
		<td width="57%" class="heardertop1">碎片标题</td>
		<td width="17%" class="heardertop1">添加时间</td>
		<td width="9%" class="heardertop1">修改</td>
		</tr>
		
		<%PinLuo.PinLuo_Blocklist OnepageNum,SearchKeyword,SearchSelect,"PinLuo_Block"%>
	...
	<div id="page">
		<div id="add">
            ...
            <input name="button1" type="button" class="buttonadd" value="新增" onClick="location.href='PinLuo_Block.asp?Act=add';">
			<input name="button4" type="button" class="buttondel" value="删除" onClick="submit_to('PinLuo_Block.asp?Act=del');">
		</div>
        <div>
