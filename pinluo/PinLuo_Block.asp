...
<%if act="add" then%>	
	...
	<td class="tableleft">
        ...
        <tr>
		  ...
		  <td width="85%" class="tableright1"><textarea name="Block_Content" id="myEditor" style="width:96%;height:450px;"></textarea>
...
%>
	...
	<td class="tableleft">
        ...
        <tr>
		  <td width="15%" class="tableleft1"><strong>碎片内容：</strong></td>
		  <td width="85%" class="tableright1"><textarea name="Block_Content" id="myEditor" style="width:96%;height:450px;"><%if trim(PinLuo.Block_Content)<>"" then response.Write(server.HTMLEncode(PinLuo.Block_Content))%></textarea>
<script type="text/javascript">
    var editor = new UE.ui.Editor();
    editor.render("myEditor");
    //UE.getEditor('myEditor')
