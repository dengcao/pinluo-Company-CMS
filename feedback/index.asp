...
///////////////////////////////////////////////////////////////////////////////////////////
	function WinOpenSmall(url,width,height)
	{
		...
		window.open(url,"show_feedback", styleStr);
	}
                      ...
                      <TD>
                        ...
                        cellSpacing=0 cellPadding=0 border=0>
                          ...
                          <TR>
                            ...
                            <TD id=oINNER 
                            style="PADDING-RIGHT: 1px; PADDING-LEFT: 3px; PADDING-TOP: 1px;width:100%;" 
								align=middle bgColor=#f7f7f7>
								<style>.fb_table td{padding: 10px;}</style>
                              <TABLE width="100%" class="fb_table"
                                align="left" 
                              cellPadding=0 cellSpacing=0 borderColorLight=#bbbbbb borderColorDark=#ffffff 
                              bgColor=#ffffff>
                                <TBODY>
                                ...
                                <TD width="16%" bgColor=#f1f1f1><div align="left">留言时间</div></TD>
                                <TD width="8%" bgColor=#f1f1f1><div align="left">联系人</div></TD></TR>
                                
                                <%
PagelistHtmlSt="<TR bgColor=#ffffff height=27><TD align=middle height=27><div align=""left"">{$feedbackid}</div></TD><TD style=""PADDING-LEFT: 4px""><div align=""left""><A style=""COLOR: #333"" href=""javascript:;"" onClick=""WinOpenSmall('s.asp?{$feedbackid}.html','900','500');"">{$feedbacktitle}</A></div></TD><TD style=""PADDING-LEFT: 4px"" align=middle><div align=""left"">{$time}</div></TD><TD align=middle><div align=""left"">{$author}</div></TD></TR>"&vbcrlf
...
<%=pinluo.Pinluo_showpage_temp%>
                  ...
                  <TABLE style="TABLE-LAYOUT: fixed;margin-top: 10px;" height=28 cellSpacing=0 
                  cellPadding=0 width="100%" border=0>
                    <TBODY>
                    <TR height=3 width="100%">
                      <TD>
