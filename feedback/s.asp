...
<body>
<br>
<table width="98%" height=28 border=0 align="center" cellPadding=0 cellSpacing=0 style="text-align: left;margin:auto;">
  <tbody>
    ...
    <tr>
      <td><table style="table-LAYOUT: fixed" height="100%" width="100%" cellSpacing=0 cellPadding=0 border=0>
          <tbody>
            <tr>
