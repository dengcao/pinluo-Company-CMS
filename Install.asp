...
PinLuo.DBConnEnd:Set PinLuo=Nothing
    ...
    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="table1">
		<tr>
		<td style="padding:12px; text-align:left; font-weight:normal; font-size:13px;"><font color=red><b>系统已经安装成功！</b></font><br><br><br /><center><input name='button' onclick="location.href='<%=sqlDbPath_ml&"pinluo/"%>';" class=button type=button value='登录后台'>&nbsp;&nbsp;<input name='button' onclick="location.href='<%=sqlDbPath_ml%>';" class=button type=button value='浏览首页'></center></td>
		</tr>
...
<%
if Installnow=true then fileUpdate "Install.asp","Install.asp-bak"
...
Function WriteFile(path)
  ...
  st.Open()
	st.WriteText "<" & "%" & vbcrlf
	st.WriteText "'设置数据库路径，品络科技 www.5300.cn" & vbcrlf
