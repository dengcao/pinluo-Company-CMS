...
<%if act="add" then%>	
	...
	<td class="tableleft">
        ...
        <textarea name="FeedbackContent" style="display:none"></textarea><iframe id="eWebEditor1" src="../editor/ewebeditor.htm?id=FeedbackContent&style=pinluo" frameBorder="0" width="100%" scrolling="no" height="350"></iframe>
        </td>
		</tr>
        <tr>
		...
		<td class="tableright1">
        <textarea name="ReplyContent" style="display:none"></textarea><iframe id="eWebEditor1" src="../editor/ewebeditor.htm?id=ReplyContent&style=mini" frameBorder="0" width="100%" scrolling="no" height="150"></iframe>
        </td>
		</tr>
...
%>
	...
	<td class="tableleft">
		...
		<td class="tableleft1"><strong>内容：</strong></td>
		<td class="tableright1">
        <textarea name="FeedbackContent" style="display:none"><%if trim(PinLuo.FeedbackContent)<>"" then response.Write(server.HTMLEncode(PinLuo.FeedbackContent))%></textarea><iframe id="eWebEditor1" src="../editor/ewebeditor.htm?id=FeedbackContent&style=pinluo" frameBorder="0" width="100%" scrolling="no" height="350"></iframe>
        </td>
		</tr>
        <tr>
		<td class="tableleft1"><strong>留言者：</strong></td>
		...
		<td class="tableleft1"><strong>回复内容：</strong></td>
		<td class="tableright1">
        <textarea name="ReplyContent" style="display:none"><%if trim(PinLuo.ReplyContent)<>"" then response.Write(server.HTMLEncode(PinLuo.ReplyContent))%></textarea><iframe id="eWebEditor1" src="../editor/ewebeditor.htm?id=ReplyContent&style=mini" frameBorder="0" width="100%" scrolling="no" height="150"></iframe>
        </td>
		</tr>
