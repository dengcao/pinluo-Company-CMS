		...
		<td>
			...
			<div class="menumain" id="div6" style="display:none">
				<ul>					
                    ...
                    <li><span onMouseOver="this.className = 'leftmenubg'" onMouseOut="this.className='none'"><a href="http://www.5300.cn/tool/" target="_blank">站长工具</a></span></li>
                    <li><span onMouseOver="this.className = 'leftmenubg'" onMouseOut="this.className='none'"><a href="http://www.pinluo.com/services/domain/" target="_blank">域名查询</a></span></li>
                    <li><span onMouseOver="this.className = 'leftmenubg'" onMouseOut="this.className='none'"><a href="http://www.pinluo.com/services/webhosting/" target="_blank">网站空间</a></span></li>
				</ul>
				<div id="menubottom"></div>
			</div>
		</td>
	...
	<tr>
		<td>
			...
			<div class="menumain" id="div7">
				<ul>
					<li><span onMouseOver="this.className = 'leftmenubg'" onMouseOut="this.className='none'"><a href="http://www.5300.cn/help/?classid=26" target="_blank">在线帮助</a></span></li>
                    <li><span onMouseOver="this.className = 'leftmenubg'" onMouseOut="this.className='none'"><a href="http://www.5300.cn/cms/qycms/template.asp" target="_blank">模板下载</a></span></li>
                    <li><span onMouseOver="this.className = 'leftmenubg'" onMouseOut="this.className='none'"><a href="http://www.5300.cn/cms/qycms/update.asp" target="_blank">升级更新</a></span></li>
                    <li><span onMouseOver="this.className = 'leftmenubg'" onMouseOut="this.className='none'"><a href="http://www.5300.cn/cms/qycms/license.asp" target="_blank">版权声明</a></span></li>
				</ul>
				<div id="menubottom"></div>
			</div>
		</td>
