...
(多个用,分隔)</td>
        ...
        <textarea name="InfoContent" style="display:none"></textarea><iframe id="eWebEditor1" src="../editor/ewebeditor.htm?id=InfoContent&style=pinluo" frameBorder="0" width="100%" scrolling="no" height="350"></iframe>
        </td>
		</tr>
        <tr>
		<td class="tableleft1"><strong>缩略图：</strong></td>
		<td class="tableright1"><input type='text' size='25' maxlength='255' name='InfoImg' class='input'><input type=button value="上传图片" onclick="showUploadDialog('image', 'form1.InfoImg', '')">&nbsp;&nbsp;(选填)
</td>
		</tr>
        <tr>
...
(多个用,分隔)</td>
		...
		<td class="tableleft1"><strong>内容：</strong></td>
		<td class="tableright1">
        <textarea name="InfoContent" style="display:none"><%if trim(PinLuo.InfoContent)<>"" then response.Write(server.HTMLEncode(PinLuo.InfoContent))%></textarea><iframe id="eWebEditor1" src="../editor/ewebeditor.htm?id=InfoContent&style=pinluo" frameBorder="0" width="100%" scrolling="no" height="350"></iframe>
        </td>
		</tr>
        <tr>
		<td class="tableleft1"><strong>缩略图：</strong></td>
		<td class="tableright1"><input type='text' size='25' maxlength='255' name='InfoImg' class='input' value="<%=PinLuo.InfoImg%>"><input type=button value="上传图片" onclick="showUploadDialog('image', 'form1.InfoImg', '')">&nbsp;&nbsp;(选填)
</td>
		</tr>
        <tr>
		<td class="tableleft1"><strong>作者：</strong></td>
