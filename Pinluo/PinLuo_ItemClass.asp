...
%>
	...
	<td class="tableleft">
        ...
        <textarea name="ClassContents" style="display:none"></textarea><iframe id="eWebEditor1" src="../editor/ewebeditor.htm?id=ClassContents&style=pinluo" frameBorder="0" width="100%" scrolling="no" height="350"></iframe>
        </td>
		</tr>
		<tr>
		...
		<td class="tableleft1"><strong>栏目内容：</strong></td>
		<td class="tableright1">
        <textarea name="ClassContents" style="display:none"><%if trim(PinLuo.ClassContents)<>"" then response.Write(server.HTMLEncode(PinLuo.ClassContents))%></textarea><iframe id="eWebEditor1" src="../editor/ewebeditor.htm?id=ClassContents&style=pinluo" frameBorder="0" width="100%" scrolling="no" height="350"></iframe>
        </td>
		</tr>
		<tr>
		  <td height="55" align="center" class="tableleft1" style="height:39px;">&nbsp;</td>
