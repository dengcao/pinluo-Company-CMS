...
'☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆
'☆                                                                                                          ☆
'☆  系 统：品络企业网站管理系统 Version 1.0                                                                 ☆
'☆  日 期：2010-05                                                                                          ☆
'☆  开 发：品络科技(www.5300.cn)  品络互联(www.pinluo.com)                                               ☆
'☆                                                                                                          ☆
'☆  声 明: 请尊重法律，保留此版权声明信息！本文字不会影响系统的正常运行。                                   ☆
'☆         根据《中华人民共和国著作权法》,品络科技(www.5300.cn)对本系统拥有一切版权！                    ☆
'☆                                                                                                          ☆
'☆         本系统开源，但不代表你可以随意剽窃或修改后非法出售，否则我们追究一切法律责任。                   ☆
'☆         如用于商业用途，请联系我们购买使用权，获得我们授权后方可。                                       ☆
'☆         免费版仅用于个人或其他福利性等非盈利组织，未授权的不得用于商业用途，否则我们追究相应法律责任。   ☆
'☆                                                                                                          ☆
'☆  Copyright (C) 2007-2010 品络科技(pinluo.com) All Rights Reserved.                                       ☆
'☆                                                                                                          ☆
'☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆
...
Public Sub PinLuo_InfoListView(OnepageNum,SearchKeyword,SearchSelect,SearchClassID,Datatable,ClassDatatable)
	...
	response.Write("<td align=left>"&gotTopic(RsList("InfoTitle"),46))
...
Public Sub PinLuo_ProductListView(OnepageNum,SearchKeyword,SearchSelect,SearchClassID,Datatable,ClassDatatable)
	...
	response.Write("<td align=left>"&gotTopic(RsList("ProName"),46)&" ")
...
Public Sub PinLuo_AdminList(OnepageNum,SearchKeyword,SearchSelect,Datatable)
	...
	response.Write("<td><a href=""http://www.5300.cn/tool/ip/?domain="&trim(RsList("LastLoginIP"))&""" target=_blank>"&RsList("LastLoginIP")&"</td>"&vbcr)
...
Public Sub PinLuo_FeedbackListView(OnepageNum,SearchKeyword,SearchSelect,SearchClassID,Datatable,ClassDatatable)
	...
	response.Write("<td align=left>"&gotTopic(RsList("FeedbackTitle"),46))
	response.Write("</td>"&vbcr)
...
Public Sub WriteSaveFile(TxtContent,FilePath)
  ...
  st.Charset="utf-8"
  st.Open()
	'st.WriteText "<!-- 该文件生成于"&now&"，由品络科技(www.5300.cn)自主开发的企业网站管理系统自动生成。-->"& vbcrlf
